...
namespace com.ds201625.fonda.View.BackOfficePresenter.Reservations
{
    public class DetailReservationPresenter : Presenter
    {
        ...
        public DetailReservationPresenter(IDetailReservationContract viewDetailReservation)
            : base(viewDetailReservation)
        {
            //Enlace Modelo - Vista
            _view = viewDetailReservation;
        }

        //    ///<summary>
        //    ///Metodo para llenar la tabla de Reservaciones
        //    /// </summary>
        ...
        //        int _reservationId, _restaurantId;
        //        List<int> parameters;
        //        List<Object> result;
        ...
        //        try
        //        {
        //            _reservationId = GetQueryParameter();
        //            _restaurantId = int.Parse(_view.SessionRestaurant);


        //            //TODO (Reservation): Puede que necesitemos el id del comensal
        //            //Recibe 2 enteros
        //            // 1  es el numero de la reservacion
        //            // 2 es el id del restaurant                
        //            parameters = new List<int> { _reservationId, _restaurantId };
        ...
        //            _reservation = (Reservation)result[1];
