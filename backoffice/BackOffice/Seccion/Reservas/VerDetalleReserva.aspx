...
<asp:Content ID="Content3" ContentPlaceHolderID="subtitulo" runat="server">
    Orden # <%=Session["ReservationNumber"]%>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="migas" runat="server">
    ...
    <div>
        <ol class="breadcrumb" style="background-color: rgba(0,0,0,0);">
            <li>
                <a href="../Reservas/ListarReservas.aspx">Reservaciones</a>
            </li>
            <li class="active">
                Detalle
            </li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Detalle de la Reservacion</h3>
