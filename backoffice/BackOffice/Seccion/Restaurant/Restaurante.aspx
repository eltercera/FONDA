...
<div class="row">
            ...
            <div class="modal fade" id="agregar" role="dialog">
                ...
                <div class="col-lg-5 col-md-10 col-sm-10 col-xs-10">
                        <div class="form-group">
                            <label class="control-label">Tipo</label>
                            <a data-toggle="modal" data-target="#agregarcat"><i class="fa fa-plus"></i></a>
        ...
        <!---modal categoria-->
          <div class="modal fade" id="agregarcat" role="dialog">
           <div class="modal-dialog">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-10 col-sm-10 col-xs-10">
                      ...
                      <asp:TextBox ID="TextBox10" CssClass="form-control" placeholder="ej. Japonesa" MaxLength="3" runat="server"/>
