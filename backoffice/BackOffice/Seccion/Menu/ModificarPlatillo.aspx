<%@ Page Title="" Language="C#"  MasterPageFile="~/Content/MasterUI.master" AutoEventWireup="true" CodeBehind="ModificarPlatillo.aspx.cs" Inherits="BackOffice.Seccion.Menu.ModificarPlatillo" %>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-8 col-sm-8 col-xs-8">
                ...
                <div id="exitoFormulario" class="alert alert-success alert-dismissable col-lg-12 col-md-10 col-sm-10 col-xs-10 col-lg-offset-1 col-md-offset-4 col-sm-offset-4 col-xs-offset-4" runat="server">
                    Plato modificado con <strong>EXITO</strong>!
                </div>
                <div id="alertaFormulario" class="alert alert-danger alert-dismissable col-lg-12 col-md-10 col-sm-10 col-xs-10 col-lg-offset-1 col-md-offset-4 col-sm-offset-4 col-xs-offset-4" runat="server">
                    El Platillo <strong>NO SE HA PODIDO MODIFICAR!</strong>
                </div>
            </div>
        </div>
           ...
           <div class="row">                               
               ...
               <p class="help-block">Imagen .jpg o .png</p>
                ...
                <div class="col-md-10 col-sm-10 col-xs-10 ">
                    <asp:Button id="Button1" Text="Modificar" CssClass="btn btn-success col-md-5 col-sm-5 col-xs-5 m-r-1" runat="server" OnClick="Button1_Click"/>
